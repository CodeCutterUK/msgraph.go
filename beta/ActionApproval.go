...
// CompletedSteps returns request builder for ApprovalStep collection
func (b *ApprovalRequestBuilder) CompletedSteps() *ApprovalCompletedStepsCollectionRequestBuilder {
	bb := &ApprovalCompletedStepsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/completedSteps"
	return bb
}

// ApprovalCompletedStepsCollectionRequestBuilder is request builder for ApprovalStep collection
type ApprovalCompletedStepsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for ApprovalStep collection
func (b *ApprovalCompletedStepsCollectionRequestBuilder) Request() *ApprovalCompletedStepsCollectionRequest {
	return &ApprovalCompletedStepsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for ApprovalStep item
func (b *ApprovalCompletedStepsCollectionRequestBuilder) ID(id string) *ApprovalStepRequestBuilder {
	bb := &ApprovalStepRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// ApprovalCompletedStepsCollectionRequest is request for ApprovalStep collection
type ApprovalCompletedStepsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for ApprovalStep collection
func (r *ApprovalCompletedStepsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]ApprovalStep, error) {
...
func (r *ApprovalCompletedStepsCollectionRequest) GetN(ctx context.Context, n int) ([]ApprovalStep, error) {
	var query string
	if r.query != nil {
...
func (r *ApprovalCompletedStepsCollectionRequest) Get(ctx context.Context) ([]ApprovalStep, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for ApprovalStep collection
func (r *ApprovalCompletedStepsCollectionRequest) Add(ctx context.Context, reqObj *ApprovalStep) (resObj *ApprovalStep, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}

// PendingSteps returns request builder for ApprovalStep collection
func (b *ApprovalRequestBuilder) PendingSteps() *ApprovalPendingStepsCollectionRequestBuilder {
	bb := &ApprovalPendingStepsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/pendingSteps"
	return bb
}

// ApprovalPendingStepsCollectionRequestBuilder is request builder for ApprovalStep collection
type ApprovalPendingStepsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for ApprovalStep collection
func (b *ApprovalPendingStepsCollectionRequestBuilder) Request() *ApprovalPendingStepsCollectionRequest {
	return &ApprovalPendingStepsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for ApprovalStep item
func (b *ApprovalPendingStepsCollectionRequestBuilder) ID(id string) *ApprovalStepRequestBuilder {
	bb := &ApprovalStepRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// ApprovalPendingStepsCollectionRequest is request for ApprovalStep collection
type ApprovalPendingStepsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for ApprovalStep collection
func (r *ApprovalPendingStepsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]ApprovalStep, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
// GetN performs GET request for ApprovalStep collection, max N pages
func (r *ApprovalPendingStepsCollectionRequest) GetN(ctx context.Context, n int) ([]ApprovalStep, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for ApprovalStep collection
func (r *ApprovalPendingStepsCollectionRequest) Get(ctx context.Context) ([]ApprovalStep, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for ApprovalStep collection
func (r *ApprovalPendingStepsCollectionRequest) Add(ctx context.Context, reqObj *ApprovalStep) (resObj *ApprovalStep, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
