...
// PrintUsageSummaryByPrinter undocumented
type PrintUsageSummaryByPrinter struct {
	// Entity is the base model of PrintUsageSummaryByPrinter
	Entity
...
// PrintUsageSummaryByUser undocumented
type PrintUsageSummaryByUser struct {
	// Entity is the base model of PrintUsageSummaryByUser
	Entity
	// CompletedBlackAndWhiteJobCount undocumented
	CompletedBlackAndWhiteJobCount *int `json:"completedBlackAndWhiteJobCount,omitempty"`
	// CompletedColorJobCount undocumented
