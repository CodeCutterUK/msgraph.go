...
type Approval struct {
	...
	Entity
	// CompletedSteps undocumented
	CompletedSteps []ApprovalStep `json:"completedSteps,omitempty"`
	// PendingSteps undocumented
	PendingSteps []ApprovalStep `json:"pendingSteps,omitempty"`
