...
type SensitiveContentLocation struct {
	// SensitiveContentLocationBase is the base model of SensitiveContentLocation
	SensitiveContentLocationBase
	// Confidence undocumented
	Confidence *int `json:"confidence,omitempty"`
}

// SensitiveContentLocationBase undocumented
type SensitiveContentLocationBase struct {
	// Object is the base model of SensitiveContentLocationBase
	Object
