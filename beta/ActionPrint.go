...
// Reports returns request builder for ReportRoot collection
func (b *PrintRequestBuilder) Reports() *PrintReportsCollectionRequestBuilder {
	bb := &PrintReportsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/reports"
	return bb
}

// PrintReportsCollectionRequestBuilder is request builder for ReportRoot collection
type PrintReportsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for ReportRoot collection
func (b *PrintReportsCollectionRequestBuilder) Request() *PrintReportsCollectionRequest {
	return &PrintReportsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for ReportRoot item
func (b *PrintReportsCollectionRequestBuilder) ID(id string) *ReportRootRequestBuilder {
	bb := &ReportRootRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// PrintReportsCollectionRequest is request for ReportRoot collection
type PrintReportsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for ReportRoot collection
func (r *PrintReportsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]ReportRoot, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
// GetN performs GET request for ReportRoot collection, max N pages
func (r *PrintReportsCollectionRequest) GetN(ctx context.Context, n int) ([]ReportRoot, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for ReportRoot collection
func (r *PrintReportsCollectionRequest) Get(ctx context.Context) ([]ReportRoot, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for ReportRoot collection
func (r *PrintReportsCollectionRequest) Add(ctx context.Context, reqObj *ReportRoot) (resObj *ReportRoot, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
